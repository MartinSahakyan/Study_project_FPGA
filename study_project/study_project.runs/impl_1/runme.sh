...
HD_PWD='C:/Users/marti/OneDrive/Documents/RTL_design/study_project/study_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log segment_2_numbers.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source segment_2_numbers.tcl -notrace
