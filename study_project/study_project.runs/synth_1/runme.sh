...
HD_PWD='C:/Users/marti/OneDrive/Documents/RTL_design/study_project/study_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log segment_2_numbers.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source segment_2_numbers.tcl
